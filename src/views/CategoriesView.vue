...
export default {
  ...
  async created() {
    this.categories = await categoriesApi.searchAllTheCategories();
  },
  methods: {
    async save() {
      if (this.category.id) {
        ...
        <div class="home__container container">
          <div class="home__info">
            ...
            <div class="input__info">
              <input type="text" class="home__input" placeholder="Insert category's name" v-model="category.category" @keyup.enter="save">
            </div>
            <div class="input__info">
              <input type="number" class="home__input" placeholder="Insert category's number" v-model="category.number" @keyup.enter="save">
            </div>
            <div class="input__info">
              <input type="text" class="home__input" placeholder="Insert category's type" v-model="category.type" @keyup.enter="save">
            </div>
          ...
          <tbody>
            <tr v-for="category in categories" :key="category.id">
              ...
              <td>{{ category.type }}</td>
              <td>
                <button class="info__button" @click="edit(category)">EDIT</button>
              </td>
            </tr>
          </tbody>
